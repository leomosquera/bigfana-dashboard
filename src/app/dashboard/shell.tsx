 ...
 *
 * `relative z-0 isolate` on the root bounds in-app stacking (sticky tables,
 * motion layers) so body-portaled overlays (Modal, Drawer, Radix) paint above.
 */
  ...
  return (
    <div
      className="
        ...
        flex h-screen overflow-hidden bg-[#06060A]
      "
    >
